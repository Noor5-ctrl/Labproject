...
![alt text](/CC_Noor_048/LabProject_FrontendBackend/screenshots/image.png)
### Terraform Plan/Apply:

1. **terraform init works.**
![alt text](/CC_Noor_048/LabProject_FrontendBackend/screenshots/image0.png)

2. **terraform apply -auto-approve successfully:**
![alt text](/CC_Noor_048/LabProject_FrontendBackend/screenshots/image1.png)
### Runtime Behavior:

1. **`http://<backend-N-public-ip>/` shows distinct backend pages.**
- Backend-1 & Backend-2:
![alt text](/CC_Noor_048/LabProject_FrontendBackend/screenshots/image2.png)

**2. When backend 1 and 2 httpd services are stopped:**
- `http://<frontend-public-ip>/` returns backup backend page.
![alt text](/CC_Noor_048/LabProject_FrontendBackend/screenshots/image3.png)
...
```
![alt text](/CC_Noor_048/LabProject_FrontendBackend/screenshots/image4.png)
